<x-app-layout>
    ...
    <div class="container-fluid">
                        ...
                        <div class="profile-info">
                            <div class="profile-details">
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="profile-email px-2 pt-2">
                                        <h4 class="text-muted mb-0">{{ date('d-m-Y', strtotime($event->end_date_event)) }}
                                        </h4>
                                        <p>Berakhir Event</p>
                                    </div>
                                </div>
                                <div class="profile-email px-2 pt-2">
                                    <h4 class="text-muted mb-0">{{ date('d-m-Y', strtotime($event->start_date_rpc)) }}
                                    </h4>
                                    <p>Pengambilan Racepack</p>
                                </div>
                                <div class="dropdown ms-auto">
                                    ...
                                    @php
                                    $disabled = $event->event_validation != 1 ? 'disabled pointer-events-none text-muted' : '';
                                    $toggleCategory = $event->event_validation != 1 ? '' : 'data-bs-toggle=modal data-bs-target=#modalCategory';
                                    $toggleScan = $event->event_validation != 1 ? '' : 'data-bs-toggle=modal data-bs-target=#scanModal';
                                    @endphp

                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li class="dropdown-item">
                                            <i class="fa fa-ticket text-primary me-2"></i>
                                            <a href="#" class="{{ $disabled }}" {!! $toggleCategory !!}>Tambah Kategori</a>
                                        </li>
                                        <li class="dropdown-item">
                                            <i class="fa-solid fa-qrcode text-primary me-2"></i>
                                            <a href="#" class="{{ $disabled }}" {!! $toggleScan !!}>Scan QR</a>
                                        </li>
                                    </ul>
        ...
        @if($event->event_validation != 1)
        <div class="alert alert-danger">Anda tidak bisa menambahkan Kategori Event sebelum ada persetujuan dari admin</div>
        @endif
        <div id="ticket-list">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-primary alert-dismissible fade show">
                            <ul>
                                <li>Format BIB harus ada karakter # untuk generate otomatis berupa urutan.</li>
                                <li>Jadi jika format bib F5#### maka urutan pertama pendaftar adalah F50001 dst.</li>
                            </ul>
                        </div>
                        @csrf
                        @if (session('error'))
                        ...
                        <div class="row">
                            <div class="mb-2 col-lg-6">
                                <label>Format BIB Pria<span class="required">*</span></label>
                                <input type="text" name="format_bib_m"
                                    class="form-control @error('format_bib_m') is-invalid @enderror" placeholder="M5####">
                                @error('format_bib_m')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-2 col-lg-6">
                                <label>Format BIB Wanita<span class="required">*</span></label>
                                <input type="text" name="format_bib_f"
                                    class="form-control @error('format_bib_f') is-invalid @enderror" placeholder="F5####">
                                @error('format_bib_f')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
    ...
    <script>
        ...
        function ambilRacepack(order_id, from) {
            isProcessing = true;
            $("#scan-result").html("Memproses...");
            $.ajax({
